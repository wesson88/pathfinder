...
/** top2 维度组合 → 职业原型（key 为两维度 key 字典序拼接；coreDims 决定理想画像向量） */
export const ARCHETYPES: Record<string, Archetype> = {
  'creativity+insight': {
    name: '洞察型策划者',
    slogan: '看见规律，也看见可能',
    strength: '你不仅能看清问题本质，也善于把模糊想法转化为可沟通的方向',
  ...
  'action+insight': {
    name: '敏锐型破局者',
    slogan: '在混沌中快速找到切入口',
    strength: '你擅长快速判断并动手验证，行动就是你最好的思考方式',
  ...
  'collab+insight': {
    name: '共创型智囊',
    slogan: '把不同的声音整合成答案',
    strength: '你擅长倾听与连接，能把不同人的想法整合成清晰的方案',
  ...
  'insight+stability': {
    name: '稳健型分析者',
    slogan: '在不确定中建立秩序',
    strength: '你擅长在不确定中建立秩序，给出可靠的判断依据',
  ...
  'action+creativity': {
    name: '开创型探索者',
    slogan: '天生适合从 0 到 1',
    strength: '你擅长把灵感快速变成现实，新事物对你有天然的吸引力',
  ...
  'collab+creativity': {
    name: '灵感型共创者',
    slogan: '让协作充满新意',
    strength: '你擅长激发团队的想象力，让一起做事变得有趣且有产出',
  ...
  'creativity+stability': {
    name: '匠心型设计者',
    slogan: '既新颖，又可靠',
    strength: '你擅长打磨细节，让想法既保有新意又经得起推敲',
  ...
  'action+collab': {
    name: '推动型连接者',
    slogan: '让一群人把事情做成',
    strength: '你擅长带动节奏、连接资源，是团队里天生的发动机',
  ...
  'action+stability': {
    name: '自律型实干家',
    slogan: '说到做到的确定性',
    strength: '你擅长持续稳定地产出结果，是可以托付重要事情的人',
  ...
  'collab+stability': {
    name: '守护型支持者',
    slogan: '值得信赖的后盾',
    strength: '你擅长照顾团队与流程，让身边的人安心、让事情有序',
